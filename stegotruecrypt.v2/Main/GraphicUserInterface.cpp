...
namespace TrueCrypt
{
	...
	shared_ptr <VolumeInfo> GraphicUserInterface::MountVolume (MountOptions &options) const
	{
		...
		shared_ptr <VolumeInfo> volume; //tu som dosiel 1
...
#	error TC_RESOURCE_DIR undefined
	...
	FilePath GraphicUserInterface::SelectVolumeFile (wxWindow *parent, bool saveMode, const DirectoryPath &directory) const
	{
		...
		extensions.push_back (make_pair (L"tc", wstring(LangString["TC_VOLUMES"]))); //explicitne pretypovanie na wstring mY
	...
	DirectoryPath GraphicUserInterface::SelectStegoDirectory (wxWindow *parent) const //momo
	{

     //   Gui->ShowInfo (_("TODO GraphicUserInterface::SelectStegoDirectory"));
		return Gui->SelectDirectory (parent, _("GraphicUserInterface::SelectStegoFiles"), true);
