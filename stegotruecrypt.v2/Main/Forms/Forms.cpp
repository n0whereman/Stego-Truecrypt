...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxBoxSizer* bSizer191momo; // momo
	bSizer191momo = new wxBoxSizer( wxVERTICAL ); //momo
	...
	bSizer191momo->SetMinSize( wxSize( 138,34 ) ); //momo
	SelectStegoButton = new wxButton( MainPanel, wxID_ANY, _("Select &Stego..."), wxDefaultPosition, wxDefaultSize, 0 ); //momo
	bSizer191momo->Add( SelectStegoButton, 1, wxALL|wxEXPAND, 5 ); // momo
	
    VolumeGridBagSizer->Add( bSizer191momo, wxGBPosition( 1, 4 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	...
	SelectStegoButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MainFrameBase::OnSelectStegoButtonClick ), NULL, this ); //momo
...
MainFrameBase::~MainFrameBase()
{
	...
	SelectStegoButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MainFrameBase::OnSelectStegoButtonClick ), NULL, this );
...
EncoderOptionsWizardPageBase::EncoderOptionsWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{
  
   // begin wxGlade: MyFrame4::MyFrame4
   // begin wxGlade: MyFrame5::MyFrame5
    sizer_11_staticbox = new wxStaticBox(this, -1, wxT("Encoder Algorithm"));
    static_line_2 = new wxStaticLine(this, wxID_ANY);
    const wxString *EncoderAlgorithmChoice_choices = NULL;
    EncoderAlgorithmChoice = new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, EncoderAlgorithmChoice_choices, 0);
    static_line_1 = new wxStaticLine(this, wxID_ANY);
    EncoderAlgorithmStaticText = new wxStaticText(this, wxID_ANY, wxEmptyString);
    //Slider = new wxSlider(this, wxID_ANY, 0, 0, 5);
    EncoderMaxSize = new wxStaticText(this, wxID_ANY, wxEmptyString);
	// Connect Events
	EncoderAlgorithmChoice->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnEncoderAlgorithmSelected ), NULL, this );
    EncoderAlgorithmChoice->SetMinSize(wxSize(280, 29));
    EncoderAlgorithmStaticText->SetMinSize(wxSize(400, 100));
     const wxString *BlockSize_choices = NULL;
    //Slider->SetMinSize(wxSize(280, 29));
     wxStaticBoxSizer* sizer_11 = new wxStaticBoxSizer(sizer_11_staticbox, wxVERTICAL);
    wxGridSizer* grid_sizer_4 = new wxGridSizer(2, 1, 3, 0);
    wxGridSizer* grid_sizer_3 = new wxGridSizer(3, 1, 4, 0);
    Slider = new wxSlider(this, wxID_ANY, 0, 0, 5);
    grid_sizer_3->Add(static_line_2, 0, wxEXPAND, 0);
    grid_sizer_3->Add(EncoderAlgorithmChoice, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
    grid_sizer_3->Add(static_line_1, 0, wxEXPAND, 0);
    sizer_11->Add(grid_sizer_3, 1, wxEXPAND, 0);
    sizer_11->Add(EncoderAlgorithmStaticText, 0, 0, 0);
    Slider->SetMinSize(wxSize(280, 29));
    LsbBlockSize = new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, BlockSize_choices, 0);
    LsbBlockSize->SetMinSize(wxSize(280, 29));  
    grid_sizer_4->Add(Slider, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
    grid_sizer_4->Add(LsbBlockSize, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
    grid_sizer_4->Add(EncoderMaxSize, 0, wxEXPAND, 0);
    sizer_11->Add(grid_sizer_4, 1, wxEXPAND, 0);     
	...
	// Connect Events
	//Slider->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( EncoderOptionsWizardPageBase::OnScroll ), NULL, this );
	Slider->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( EncoderOptionsWizardPageBase::OnScroll ), NULL, this );
	EncoderAlgorithmChoice->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnEncoderAlgorithmSelected ), NULL, this );
	LsbBlockSize->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnLsbAlgorithmSelected ), NULL, this );
	
}

EncoderOptionsWizardPageBase::~EncoderOptionsWizardPageBase()
{
	// Disconnect Events
	EncoderAlgorithmChoice->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnEncoderAlgorithmSelected ), NULL, this );
     Slider->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( EncoderOptionsWizardPageBase::OnScroll ), NULL, this );
}



EncoderVolumeSizePageBase::EncoderVolumeSizePageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{        //momo pridana classa
	//wxStaticText* m_staticText25;
	//wxGridSizer* gsizer;
	//gsizer = new wxGridSizer( 1,2,50,50 );
	  
	//staticText = new wxStaticText( this, wxID_ANY, _("Úložná kapacita je: "), wxDefaultPosition, wxDefaultSize, 0 );
    
   // staticText->Show(true);
   
  	                                                                                      //IMPORTANTSlider = new wxSlider(this, wxID_ANY, 0, 0, 5, wxDefaultPosition, wxSize(-1, 180), wxSL_VERTICAL);
	/*gsizer->Add(Slider, 0, wxEXPAND);
	gsizer->Add(staticText, 1, wxEXPAND);
	...
	// Connect Events
       //  Slider->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( EncoderVolumeSizePageBase::OnScroll ), NULL, this );

	//Slider->Connect(wxID_ANY, wxEVT_COMMAND_SLIDER_UPDATED, wxScrollEventHandler(EncoderOptionsWizardPageBase::OnScroll));  
	//EncoderAlgorithmChoice->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnEncoderAlgorithmSelected ), NULL, this );
	//SelectButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnSelectButtonClick ), NULL, this );
}

EncoderVolumeSizePageBase::~EncoderVolumeSizePageBase()
{
	// Disconnect Events
           //  Slider->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( EncoderVolumeSizePageBase::OnScroll ), NULL, this );

	//Slider->Disconnect(wxID_ANY, wxEVT_COMMAND_SLIDER_UPDATED, wxScrollEventHandler(EncoderOptionsWizardPageBase::OnScroll));  
	//EncoderAlgorithmChoice->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnEncoderAlgorithmSelected ), NULL, this );
	//SelectButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EncoderOptionsWizardPageBase::OnSelectButtonClick ), NULL, this );
}
...
VolumeLocationWizardPageBase::VolumeLocationWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{
	...
	SelectStegoButton = new wxButton( this, wxID_ANY, _("Select &Stego..."), wxDefaultPosition, wxDefaultSize, 0 ); //momo pridanie StegoButoniku do konstruktora
	bSizer90->Add( SelectStegoButton, 0, wxALL|wxEXPAND, 5 ); //momo pridanie Buttoniku do box sizra (kontajnera)
	...
	SelectStegoButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VolumeLocationWizardPageBase::OnSelectStegoButtonClick ), NULL, this ); //momo zaveseny event handler na connect
...
VolumeLocationWizardPageBase::~VolumeLocationWizardPageBase()
{
	...
	SelectStegoButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VolumeLocationWizardPageBase::OnSelectStegoButtonClick ), NULL, this );
