...
namespace TrueCrypt
{
	...
	class MainFrameBase : public wxFrame 
	{
		...
		protected:
			...
			virtual void OnSelectStegoButtonClick( wxCommandEvent& event ){ event.Skip(); }
	...
	class EncryptionOptionsWizardPageBase : public WizardPage
	{
        ...
        class EncoderOptionsWizardPageBase : public WizardPage
	{
		private:
		
		protected:
			wxGridSizer* grid_sizer_4;
			/*wxChoice* EncoderAlgorithmChoice;
			wxButton* SelectButton;
			wxStaticText* staticText;
			wxStaticText* EncoderAlgorithmStaticText;*/
			 // begin wxGlade: MyFrame1::attributes
        
             // end wxGlade
			   wxSlider* Slider;
			   wxStaticBoxSizer* sizer_11;
			   wxStaticBox* sizer_11_staticbox;
  			   wxStaticLine* static_line_2;
 			   wxChoice* EncoderAlgorithmChoice;
 			   wxStaticLine* static_line_1;
			   wxStaticText* EncoderAlgorithmStaticText;
		       wxChoice* LsbBlockSize;
		       wxStaticText* EncoderMaxSize;
            
			//virtual void OnScroll(wxScrollEvent& event){ event.Skip(); } //momo pravdepodobne budem musiet vyraisovat new args PageUpdatedEvent.Raise();
		...
		public:
			...
			virtual void OnEncoderAlgorithmSelected( wxCommandEvent& event ){ event.Skip(); }
			virtual void OnLsbAlgorithmSelected( wxCommandEvent& event ){ event.Skip(); }
			EncoderOptionsWizardPageBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxTAB_TRAVERSAL );
			~EncoderOptionsWizardPageBase();
		
	};


	class EncoderVolumeSizePageBase : public WizardPage 
	{
		private:
		//momo prida na classa
		protected:
			...
			// Virtual event handlers, overide them in your derived class
			//virtual void OnEncoderAlgorithmSelected( wxCommandEvent& event ){ event.Skip(); }
			//virtual void OnSelectButtonClick( wxCommandEvent& event ){ event.Skip(); }
			//virtual void OnEncryptionAlgorithmHyperlinkClick( wxHyperlinkEvent& event ){ event.Skip(); }
			//virtual void OnBenchmarkButtonClick( wxCommandEvent& event ){ event.Skip(); }
			//virtual void OnHashHyperlinkClick( wxHyperlinkEvent& event ){ event.Skip(); }
		...
		public:
			EncoderVolumeSizePageBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxTAB_TRAVERSAL );
			~EncoderVolumeSizePageBase();
